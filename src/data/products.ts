export const products = {
  ...
  "half-2pin": {
    title: "0.5 Watt 2-Pin Plug-in LED",
    images: [
  ...
  flower: {
    ...
    images: [
      "/products/flower/5W Metallic Flower RGB Lamp.jpg",
    ],
    colors: ["RGB"],
    types: ["5W"],
  ...
  jumbomotor: {
    ...
    images: [
      "/products/jumbomotor/12W Big Jumbo With Motor RGB.jpg",
    ],
    colors: ["RGB"],
    types: ["Motor Version"],
  ...
  "9-watt": {
    ...
    images: [
      "/products/9 watt/9W Metallic RGB.jpg",
    ],
    colors: ["RGB"],
    types: ["9W"],
  ...
  "gramin-4w": {
    ...
    images: [
      "/products/gramin/4W B-22 White.jpg",
    ],
    colors: ["White"],
    types: ["4W"],
  ...
  "gramin-6w": {
    ...
    images: [
      "/products/gramin/6W B-22 White.jpg",
    ],
    colors: ["White"],
    types: ["6W"],
    description: "Affordable rural lighting solution.",
  ...
  "gramin-9w": {
    ...
    images: [
      "/products/gramin/9W B-22 White.jpg",
    ],
    colors: ["White"],
    types: ["9W"],
    description: "Affordable rural lighting solution.",
